	...
	return (
		<div className="py-12 mx-auto max-w-screen-xl">
			...
			<div className="grid  md:grid-cols-2 lg:grid-cols-4 gap-4 mt-5  py-12">
				<div
					data-aos="flip-left"
					className="card  bg-gray-200 text-black-600  "
				>
				...
				<div data-aos="flip-right" className="card bg-gray-200 text-black-600">
					<div className="card-body items-center text-center">
				...
				<div data-aos="flip-left" className="card bg-gray-200 text-black-600">
					<div className="card-body items-center text-center">
